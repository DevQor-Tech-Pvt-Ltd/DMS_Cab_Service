      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative group">
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-md bg-white">
              <ImageWithFallback
                ...
                className="w-full h-[300px] sm:h-[400px] lg:h-[500px] object-contain scale-100 group-hover:scale-[1.02] transition-transform duration-700 ease-out"
                loading="lazy"
              />
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-slate-650 text-lg leading-relaxed mb-8 font-light text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:text-left space-y-3 sm:space-y-0 sm:space-x-4 group">
