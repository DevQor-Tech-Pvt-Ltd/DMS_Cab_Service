            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {showColdStartWarning && (
                <motion.div 
                  ...
                  className="rounded-xl bg-[#d4af37]/10 border border-[#d4af37]/30 px-4 py-3 text-xs text-amber-200/90 leading-relaxed text-center"
                >
                  <div className="flex items-center justify-center space-x-2 mb-1">
                    ...
                    <strong className="text-white font-serif uppercase tracking-wider text-[10px]">Server Wake-up in progress</strong>
                  </div>
